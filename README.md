...
分支：     main
白名单：   hifiti|wangchao|xijiu|quark|bilibili|fanghua|bafu|fun|tuiguangbao|duoxiang|aliyun_dev
...
```text
hifiti|wangchao|xijiu|quark|bilibili|fanghua|bafu|fun|tuiguangbao|duoxiang|aliyun_dev
```
...
```bash
ql repo https://github.com/WillpowerJin/ql-scripts.git "hifiti|wangchao|xijiu|quark|bilibili|fanghua|bafu|fun|tuiguangbao|duoxiang|aliyun_dev" "pull_access_token" "" "main" "py"
```
...
│   └── README.md
├── bafu/
│   ├── ads_mp.py             # 八富小程序协议看广告（YYB_GO+备注）+ Bark
│   ├── requirements.txt
│   └── README.md
├── fun/
